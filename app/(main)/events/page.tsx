...
export default function EventsPage() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-purple-300 via-green-200 to-pink-300 dark:!bg-gradient-to-br dark:!from-gray-900 dark:!via-gray-800 dark:!to-gray-900">
      <div className="relative z-10 min-h-screen">
        <div className="container py-8">
          <div className="flex flex-col gap-6">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tight text-foreground">NIBOG Baby Games</h1>
              <p className="text-muted-foreground dark:text-muted-foreground/90">Browse and register for baby games across 21 cities in India</p>
            </div>
