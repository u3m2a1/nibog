...
export default function Home() {
  return (
      ...
      {/* Hero Section */}
        <div className="relative min-h-screen w-full overflow-hidden  bg-gradient-to-br from-pink-300 via-yellow-200 to-blue-300 dark:!from-gray-900 dark:!via-gray-800 dark:!to-gray-950">
                  ...
                  {[
                    ...
                    <div key={`kid-${i}`} className="flex-none w-[25%] h-full">
                      <img 
                        ...
                        className="w-full h-fullobject-contain opacity-30 dark:opacity-20 mx-auto"
                        loading="lazy"
                      />
                    </div>
                  ))}
          ...
          <section className="container">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground dark:text-gray-500">Join us for these exciting events featuring multiple baby games in cities across India</p>
              </div>
              <FeaturedEvents />
            </div>
          </section>
          ...
          {/* CTA Section */}
          <section className="container">
            <div className="rounded-lg p-8 text-center md:p-12">
